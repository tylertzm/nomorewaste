...
const systemPrompt = "You are a grocery receipt parser. Extract items into a JSON array. For each item include: 'name',
'price' (number), 'category' (Produce, Dairy, Meat, Beverage, Pantry, Bakery, Frozen, Other), and 'expiry' (estimate
    ...
    <div
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar">
            ...
            <div className="space-y-4">
                ...
                <button onClick={()=> setDraftItems(prev => [...prev, { id: Math.random().toString(), name: 'New Item',
